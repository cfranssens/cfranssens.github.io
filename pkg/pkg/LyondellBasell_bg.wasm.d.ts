...
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h488b8e598f3d671c: (a: number, b: number) => void;
...
export const closure618_externref_shim: (a: number, b: number, c: any) => void;
export const closure2338_externref_shim: (a: number, b: number, c: any) => void;
export const _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h0c49767a930557f3: (a: number, b: number) => void;
